...
def generate_launch_description():
    ...
    # launch arguments — defaults for central_tunnel
    declare_agents_conf_file = DeclareLaunchArgument(
        'configuration_file', default_value='domenic/central_tunnel/ct_baseline.yaml',
    ...
    declare_arg_world = DeclareLaunchArgument(
        'base_world', default_value='central_tunnel.world',
